...
namespace TarkovHelper.Services
{
    ...
    public class ObjectiveProgressService
    {
        ...
        [Obsolete("Use ClearAllProgressAsync so the database clear is completed before importing logs.")]
        public void ClearAllProgress()
        {
            _ = ClearAllProgressAsync();
        }
