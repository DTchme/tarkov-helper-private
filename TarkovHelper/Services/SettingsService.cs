...
public class SettingsService
{
    ...
    public int PlayerLevel
    {
        ...
        set
        {
            ...
            if (_playerLevel != clampedValue)
            {
                ...
                SaveSetting(KeyPlayerLevel, clampedValue.ToString(), ProfileService.Instance.CurrentProfile);
    ...
    public double ScavRep
    {
        ...
        set
        {
            ...
            if (Math.Abs((_scavRep ?? DefaultScavRep) - clampedValue) > 0.01)
            {
                ...
                SaveSetting(KeyScavRep, clampedValue.ToString(), ProfileService.Instance.CurrentProfile);
    ...
    public int DspDecodeCount
    {
        ...
        set
        {
            ...
            if (_dspDecodeCount != clampedValue)
            {
                ...
                SaveSetting(KeyDspDecodeCount, clampedValue.ToString(), ProfileService.Instance.CurrentProfile);
    ...
    public string? PlayerFaction
    {
        ...
        set
        {
            ...
            if (_playerFaction != normalizedValue)
            {
                ...
                SaveSetting(KeyPlayerFaction, normalizedValue ?? "", ProfileService.Instance.CurrentProfile);
    ...
    public int PrestigeLevel
    {
        ...
        set
        {
            ...
            if (_prestigeLevel != clampedValue)
            {
                ...
                SaveSetting(KeyPrestigeLevel, clampedValue.ToString(), ProfileService.Instance.CurrentProfile);
    ...
    private string? GetCharacterSetting(string key)
    {
        var currentProfile = ProfileService.Instance.CurrentProfile;
        var value = _userDataDb.GetSetting(key, currentProfile);
        if (!string.IsNullOrWhiteSpace(value))
            return value;

        // v4 and older stored these character values in the global (99) slot.
        // Keep that value as a one-way compatibility fallback until this profile is edited.
        return _userDataDb.GetSetting(key);
    }
    ...
    private void LoadSettings()
    {
        ...
        try
        {
            ...
            if (int.TryParse(GetCharacterSetting(KeyPlayerLevel), out var level))
                _playerLevel = level;

            if (double.TryParse(GetCharacterSetting(KeyScavRep), out var scavRep))
                _scavRep = scavRep;
            ...
            if (int.TryParse(GetCharacterSetting(KeyDspDecodeCount), out var dspCount))
                _dspDecodeCount = dspCount;

            _playerFaction = GetCharacterSetting(KeyPlayerFaction);
            ...
            if (int.TryParse(GetCharacterSetting(KeyPrestigeLevel), out var prestige))
